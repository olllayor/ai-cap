      ...
      <div className="flex flex-col items-center gap-4 p-6 text-center transition-transform duration-300 group-hover:scale-105">
        ...
        `}>
          {error ? (
            ...
            <Upload className={`h-10 w-10 text-[var(--color-text-secondary)] transition-colors ${isDragOver ? 'text-[var(--color-accent-primary)]' : 'group-hover:text-[var(--color-text-primary)]'}`} />
          )}
        </div>
