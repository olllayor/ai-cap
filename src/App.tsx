    ...
    return (
     <div className="flex h-screen flex-col items-center justify-center bg-[var(--color-bg-primary)] p-4 text-center">
        ...
        <p className="mb-6 max-w-md text-[var(--color-text-secondary)]">
          This app relies on advanced browser features like WebAssembly and SharedArrayBuffer for client-side video processing.
        </p>
             ...
             <div className="animate-slide-up">
              ...
              {(ffmpegError || (!ffmpegLoaded && !ffmpegLoading && !ffmpegError)) && (
                <div className="mb-6 rounded-lg bg-red-500/10 border border-red-500/20 p-4 text-red-200 flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold">Core Components Failed to Load</h4>
                    <p className="text-sm opacity-80">
                      {ffmpegError || "FFmpeg failed to initialize. Please check your internet connection and reload."}
                    </p>
                  </div>
                </div>
              )}
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between mb-6 gap-4">
                ...
                <div className="flex items-center gap-3">
                  <button 
                    ...
                    disabled={isProcessing || !ffmpegLoaded || modelLoading || status === 'completed'}
                    className={`
                      flex items-center gap-2 px-4 py-2 rounded-lg font-medium text-sm transition-all
                      ${isProcessing || !ffmpegLoaded || modelLoading || status === 'completed'
